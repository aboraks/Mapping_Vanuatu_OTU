...
library(dplyr)
```
load up the csv file and set working diretory
```{r}
...
ggsave( plot = map, filename = paste("./Mapping.single.sp/Mantel.0.05/Maps/Generalist.combined/",new_dupes[AAA,1],"Transect",new_dupes[AAA,2],".jpg"), device = NULL, path = NULL,
