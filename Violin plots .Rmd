...
Now run the same two loops (as above) but for 
#Generalists
...
This is where you should mess around with outliers 
"subset as above (eg#take.a.look <- take.a.look[take.a.look$Range>DDD,] # remove garbage variograms (you can also take a look at the maps in the corresponding directory))take.a.look <- take.a.look[take.a.look$Range<CCC,]# there are three OTU with large ranges - This is what they look like ->)""
```{r}
CCC=15 #meters
DDD=1  #meter 
